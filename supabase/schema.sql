...
-- =========================================================================
-- This script configures all tables, relationships, indexes, storage buckets,
-- and security policies needed across all modules of DS PROJECTS.
-- Safe to execute in Supabase SQL Editor (Idempotent: uses IF NOT EXISTS).
-- =========================================================================
...
-- Ensure all columns are present if the table was created earlier
...
CREATE TABLE IF NOT EXISTS public.attendance_records (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
    employee_id TEXT NOT NULL,
    punch_date TEXT NOT NULL,                  -- e.g. 'Sep 02, 2026' or '2026-09-02'
...
CREATE TABLE IF NOT EXISTS public.employee_documents (
    ...
    document_type TEXT,                        -- 'Aadhaar', 'PAN', 'Degree', 'Offer Copy', 'Signed Agreement'
    file_url TEXT,
    file_size TEXT,
...
CREATE TABLE IF NOT EXISTS public.notifications (
    ...
    type TEXT DEFAULT 'announcement',          -- 'announcement', 'task', 'system', 'alert'
...
-- =========================================================================
-- Create public storage bucket for PDF, DOC, XLS, images & survey uploads
INSERT INTO storage.buckets (id, name, public)
VALUES ('employee-documents', 'employee-documents', true)
ON CONFLICT (id) DO UPDATE SET public = true;

-- Storage RLS Access Policies (Upload, Read, Update, Delete)
DO $$ 
BEGIN
    IF NOT EXISTS (
...
DROP TRIGGER IF EXISTS trigger_work_tasks_updated_at ON public.work_tasks;
...
-- Create open access policies for full functionality with anon/service keys
DO $$
BEGIN
    ...
    -- Attendance Records Table Policy
    ...
    -- Employee Documents Table Policy
